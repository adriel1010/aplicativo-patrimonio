...
public class ItensConferidos extends AppCompatActivity  implements AdapterView.OnItemLongClickListener {
    ...
    public void carregarLista(){
        ...
        adapterItensConferidos = new AdapterItensConferidos(this, EquipamentoInventario.findWithQuery(EquipamentoInventario.class, "Select * from EQUIPAMENTO_INVENTARIO where local_Inventario = ? ", String.valueOf(idLocaisConferir)));
